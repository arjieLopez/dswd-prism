...
class ReferenceDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $statuses = [
            ...
            ['context' => 'procurement', 'name' => 'draft', 'display_name' => 'Draft', 'color' => 'bg-gray-100 text-gray-800'],
            ['context' => 'procurement', 'name' => 'pending', 'display_name' => 'Pending', 'color' => 'bg-yellow-100 text-yellow-800'],
            ['context' => 'procurement', 'name' => 'approved', 'display_name' => 'Approved', 'color' => 'bg-green-100 text-green-800'],
            ['context' => 'procurement', 'name' => 'rejected', 'display_name' => 'Rejected', 'color' => 'bg-red-100 text-red-800'],
            ['context' => 'procurement', 'name' => 'po_generated', 'display_name' => 'PO Generated', 'color' => 'bg-purple-100 text-purple-800'],
            ['context' => 'procurement', 'name' => 'completed', 'display_name' => 'Completed', 'color' => 'bg-indigo-100 text-indigo-800'],
