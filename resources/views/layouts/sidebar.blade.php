        ...
        @auth
            ...
            @else
                ...
                <a href="{{ route('user.requests') }}"
                    class="flex items-center px-4 py-3 rounded-lg transition-colors duration-200 {{ request()->routeIs('user.requests') ? 'bg-gradient-to-r from-blue-300 to-white font-bold text-gray-900' : 'text-gray-700 hover:bg-blue-50' }}">
