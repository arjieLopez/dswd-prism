...
<body>
    <div class="header">
        <h1>DSWD-PRISM - Purchase Requests Export</h1>
        <h2>User Purchase Requests Report</h2>
    ...
    <div class="summary">
        ...
        <div class="summary-grid">
            <div class="summary-row">
                ...
                <div class="summary-cell summary-label">Draft PRs:</div>
                <div class="summary-cell">{{ $purchaseRequests->where('status', 'draft')->count() }}</div>
            </div>
            <div class="summary-row">
